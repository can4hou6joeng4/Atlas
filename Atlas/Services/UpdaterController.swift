...
///
/// Atlas runs as a menu-bar (`LSUIElement`) app, so it has no Dock icon
...
final class UpdaterController: NSObject {
    static let updateAvailabilityDidChange = Notification.Name("Atlas.updateAvailabilityDidChange")
