            ...
            SettingGroup(title: "Startup") {
                VStack(spacing: 0) {
                    SettingRow(title: "Launch at login",
                               description: "Open Atlas automatically when you log in to your Mac.") {
            ...
            SettingGroup(title: "Language") {
                VStack(spacing: 0) {
                    SettingRow(title: "App language",
                               description: "Choose the language Atlas uses after the next restart.") {
            ...
            SettingGroup(title: "Refresh") {
                VStack(spacing: 0) {
                    SettingRow(title: "Refresh every",
                               description: "How often Atlas re-scans your session logs in the background.") {
