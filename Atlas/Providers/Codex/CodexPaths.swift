...
struct CodexPaths: Sendable, Hashable {
    ...
    /// Atlas-owned undo backups for future delete-to-recycle-bin support.
    var atlasUndoDirectory: URL { homeDirectory.appendingPathComponent(".atlas-undo", isDirectory: true) }
