...
Thanks for helping improve Atlas. This repository is intended to stay
...
Do not launch development builds with `open -a Atlas`; this menu-bar app
...
- Keep provider-specific parsing under `Atlas/Providers/<Provider>/`.
...
- Ideas, questions, and "is this a bug or expected?" → [GitHub Discussions](https://github.com/can4hou6joeng4/Atlas/discussions).
- Reproducible bugs and concrete feature requests → [Issues](https://github.com/can4hou6joeng4/Atlas/issues) (please use the templates).
